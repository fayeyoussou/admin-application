...
public class APIExceptionHandler {
    ...
    @ExceptionHandler(value = {NoInstatiateException.class})
    public ResponseEntity<APIException> handleNoInstatiateException(NoInstatiateException e) {
        APIException exception = new APIException(e.getMessage(), HttpStatus.FORBIDDEN, LocalDateTime.now());
        return new ResponseEntity<>(exception, HttpStatus.NOT_FOUND);
    }
